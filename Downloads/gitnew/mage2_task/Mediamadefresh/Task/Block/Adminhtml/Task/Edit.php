...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Mediamadefresh_Task::task_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('task')->getId()) {
            return __("Edit Task '%1'", $this->escapeHtml($this->_coreRegistry->registry('task')->getTitle()));
        } else {
            return __('New Task');
        }
    }
    ...
    {
        return $this->getUrl('task/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
