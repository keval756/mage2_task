...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getTask()->getTitle());
    }
    ...
    {
        return $this->_coreRegistry->registry('current_task');
    }
    ...
    {
        return $this->getUrl('task/index/index');
    }
    ...
    public function getBackTitle()
    {
        if ($this->httpContext->getValue(Context::CONTEXT_AUTH)) {
            return __('Back to Task');
        }
        return __('View Another Task');
    }
