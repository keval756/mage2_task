 ...
 * Task data helper
 */
namespace Mediamadefresh\Task\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @var string
     */
    const XML_PATH_ENABLED            = 'task/view/enabled';

    /**
     * Path to store config where count of task posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'task/view/items_per_page';

    /**
     * Path to store config where count of days while task is still recently added is stored
     *
     * @var string
     */
    const XML_PATH_DAYS_DIFFERENCE    = 'task/view/days_difference';
    ...
    /**
     * Checks whether task can be displayed in the frontend
     * @return boolean
     */
    ...
    /**
     * Return difference in days while task is recently added
     * @return int
     */
    ...
    /**
     * Remove task item image by image filename
     *
     ...
     *
     * @param Mediamadefresh_Task_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Mediamadefresh\Task\Model\Task $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Task Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Task Item images
     *
     * @return string
     */
